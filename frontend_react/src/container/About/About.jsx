...
const abouts = [
  { title: 'API Developer', description: 'I am a API (application programming interface) developer with a passion for developing APIs that are essential in app development across multiple devices, databases and servers.', imgUrl: images.about01 },
